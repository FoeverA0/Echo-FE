...
import { getListingObjectPrice } from "@/utils/aptos";
...
const NftDetails = () => {
  ...
  //
  // // 添加 useEffect 来调用 getListingObjectPrice
  // useEffect(() => {
  //   const fetchPrice = async () => {
  //     try {
  //       const fetchedPrice = await getListingObjectPrice(id);
